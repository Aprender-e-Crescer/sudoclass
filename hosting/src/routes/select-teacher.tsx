...
export const Route = createFileRoute('/select-teacher')({
...
const ProfessorItem: React.FC<{ professor: Professor; index: number }> = ({ professor, index }) => {
  ...
  return (
    ...
    >
      <div className={`${colors[index % colors.length]} w-10 h-10 rounded-full text-white flex items-center justify-center font-semibold`}>
        {professor.initials}
      </div>
