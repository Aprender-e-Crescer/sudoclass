...
export function movieByGenreRef(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars);
  if('_useGeneratedSdk' in dcInstance) {
    dcInstance._useGeneratedSdk();
  } else {
...
export function movieByGenre(dcOrVars, vars) {
  return executeQuery(movieByGenreRef(dcOrVars, vars));
}
export function movieByGenreInsensitiveRef(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars);
  if('_useGeneratedSdk' in dcInstance) {
    dcInstance._useGeneratedSdk();
  } else {
...
export function movieByGenreInsensitive(dcOrVars, vars) {
  return executeQuery(movieByGenreInsensitiveRef(dcOrVars, vars));
}
export function moviesssRef(dc) {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  if('_useGeneratedSdk' in dcInstance) {
    dcInstance._useGeneratedSdk();
  } else {
