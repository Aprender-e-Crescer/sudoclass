...
export interface MovieByGenreData {
  mostPopular: ({
    id: UUIDString;
    title: string;
    genre?: string | null;
...
export interface MovieByGenreInsensitiveData {
  mostPopular: ({
    id: UUIDString;
    title: string;
    genre?: string | null;
...
export interface MovieByGenreInsensitiveVariables {
  genre?: string | null;
}
...
/* Allow users to create refs without passing in DataConnect */
export function movieByGenreRef(vars?: MovieByGenreVariables): QueryRef<MovieByGenreData, MovieByGenreVariables>;
/* Allow users to pass in custom DataConnect instances */
export function movieByGenreRef(dc: DataConnect, vars?: MovieByGenreVariables): QueryRef<MovieByGenreData,MovieByGenreVariables>;

export function movieByGenre(vars?: MovieByGenreVariables): QueryPromise<MovieByGenreData, MovieByGenreVariables>;
export function movieByGenre(dc: DataConnect, vars?: MovieByGenreVariables): QueryPromise<MovieByGenreData,MovieByGenreVariables>;


/* Allow users to create refs without passing in DataConnect */
export function movieByGenreInsensitiveRef(vars?: MovieByGenreInsensitiveVariables): QueryRef<MovieByGenreInsensitiveData, MovieByGenreInsensitiveVariables>;
/* Allow users to pass in custom DataConnect instances */
export function movieByGenreInsensitiveRef(dc: DataConnect, vars?: MovieByGenreInsensitiveVariables): QueryRef<MovieByGenreInsensitiveData,MovieByGenreInsensitiveVariables>;

export function movieByGenreInsensitive(vars?: MovieByGenreInsensitiveVariables): QueryPromise<MovieByGenreInsensitiveData, MovieByGenreInsensitiveVariables>;
export function movieByGenreInsensitive(dc: DataConnect, vars?: MovieByGenreInsensitiveVariables): QueryPromise<MovieByGenreInsensitiveData,MovieByGenreInsensitiveVariables>;


/* Allow users to create refs without passing in DataConnect */
export function moviesssRef(): QueryRef<MoviesssData, undefined>;/* Allow users to pass in custom DataConnect instances */
export function moviesssRef(dc: DataConnect): QueryRef<MoviesssData,undefined>;
