    ...
    <>
      <div className="flex flex-row md:hidden">
        <div className="flex flex-col w-full">
          <div className="flex flex-row items-center border border-[#DBDBDB] w-24 p-8 h-20">
            {avatar && (
          ...
          <div className="flex items-center justify-center border border-[#DBDBDB] w-24 h-20 text-sm text-[#292D32] text-opacity-70">
            {rating}
          </div>
